  ...
  <b-tabs type="is-toggle-rounded">
    <b-tab-item label="Tier A">
      <form v-if="rounds.find((x) => x.tier === 'A')" class="grid">
        ...
        <input v-if="token && !votes.A.AlreadyVoted" type="button" value="Submit your vote" @click="SubmitVote('A')"
    ...
    <b-tab-item label="Tier B">
      <form v-if="rounds.find((x) => x.tier === 'B')" class="grid">
        ...
        <input v-if="token && !votes.B.AlreadyVoted" type="button" value="Submit your vote" @click="SubmitVote('B')"
          class="button is-primary" />
        <input v-else-if="token" type="button" value="You already voted" disabled class="button is-primary" />
        <input v-else type="button" value="You need to log in" disabled class="button is-primary" />
      </form>
